-- Please create table opsz_evaluation in openStatAdmin before applying this patch
...
--
-- Table structure for table `opsz_evaluation`
--

DROP TABLE IF EXISTS `opsz_evaluation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsz_evaluation` (
  `id_opsz_evaluation` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_opsz_evaluation`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 `ENCRYPTED`=YES;
/*!40101 SET character_set_client = @saved_cs_client */;


--
-- Dumping data for table `opsz_evaluation_permissions`
--

LOCK TABLES `opsz_evaluation_permissions` WRITE;
/*!40000 ALTER TABLE `opsz_evaluation_permissions` DISABLE KEYS */;
DELETE FROM opsz_evaluation_permissions;
INSERT INTO `opsz_evaluation_permissions` VALUES (1,'changedat','_none_',NULL,'TIMESTAMP','NONE',NULL,'_none_'),(2,'changedby','_none_',NULL,'VARCHAR(40)','NONE',NULL,'_none_'),(3,'code','Code',3.000,'VARCHAR(20)','TEXT','(REPLACE(REPLACE(REPLACE(upper(LEFT(to_base64(UNHEX(sha1(CONCAT(NOW(),RAND())))),8)),\'/\',\'1\'),\'+\',\'2\'),\'=\',\'3\'))',NULL),(7,'evalnoeval','Wenn kein Evaluationsbogen, warum nicht?',22.000,'TEXT','FREE',NULL,NULL),(10,'fallnummerklinik','Fallnummer des Klinikums',2.500,'TEXT','TEXT',NULL,NULL),(11,'erstkontaktrefukey','Erstkontakt zu refuKey',4.000,'DATE','DATE',NULL,NULL),(12,'ueberleitung','Überleitung innerhalb refukey',5.000,'VARCHAR(40)','LIST',NULL,'_evalueberleitung'),(13,'familienstand','Familienstand',6.000,'VARCHAR(40)','LIST',NULL,'_familienstand'),(14,'familiehier','Familie hier',7.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(15,'berichtvorhanden','Bericht vorhanden',8.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(16,'berichtvon','Bericht von',9.000,'VARCHAR(60)','SUGGEST; MULTIPLE',NULL,NULL),(17,'anmerkungen','Anmerkungen',10.000,'TEXT','EDITOR',NULL,NULL),(18,'standderakte','Stand der Akte',11.000,'VARCHAR(40)','LIST',NULL,'_standderakte'),(19,'badoiiausgefuellt','BADO II ausgefüllt',12.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(20,'badoiiausgefuelltam','BADO II ausgefüllt am',13.000,'DATE','DATE',NULL,NULL),(21,'refukeyiausgefuellt','RefuKey-Fragebogen I ausgefüllt',14.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(22,'refkeyiausgefuelltam','RefuKey-Fragebogen I ausgefüllt am',15.000,'DATE','DATE',NULL,NULL),(23,'refukeyiiausgefuelltzehn','RefuKey-Fragebogen II nach 10 Sitzungen ausgefüllt',16.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(24,'refukeyiiausgefuelltzehnam','RefuKey-Fragebogen II nach 10 Sitzungen ausgefüllt am',17.000,'DATE','DATE',NULL,NULL),(25,'refukeyiiausgefuelltende','RefuKey-Fragebogen II am Ende der Sitzungen ausgefüllt',18.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(26,'refukeyiiausgefuelltendeam','RefuKey-Fragebogen II am Ende der Sitzungen ausgefüllt am',19.000,'DATE','DATE',NULL,NULL),(27,'besonderheiten','Besonderheiten / Bemerkungen zur Evaluation',20.000,'TEXT','EDITOR',NULL,NULL),(28,'gescannt','Fragebögen gescannt',21.000,'VARCHAR(8)','LIST',NULL,'_yesno'),(29,'dropout','Dropout Kategorien',23.000,'VARCHAR(60)','LIST',NULL,'_dropout');
/*!40000 ALTER TABLE `opsz_evaluation_permissions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `opsz_evaluation_references`
--

DROP TABLE IF EXISTS `opsz_evaluation_references`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsz_evaluation_references` (
