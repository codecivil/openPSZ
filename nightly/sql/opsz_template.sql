...
INSERT INTO `os_functions` VALUES (2,'edit','newEntry','Neuer Eintrag','TABLES','details new','[6]','_popup_'),(3,'traffic-light','trafficLight','Ampel','TABLES',NULL,'[0]','important'),(4,'print','printResults','Ergebnisse drucken','RESULTS',NULL,'[6]',NULL),(5,'print','printResults','Eintrag drucken','DETAILS',NULL,'[6]',NULL),(6,'file-import','importCSV','CSV-import','TABLES','details import','[6]','_popup_'),(7,'puzzle-piece','applyComplement','Komplement zu Filtern suchen','FILTERS',NULL,'[6]','results_wrapper'),(8,'comment-dots','printDB','Erzeuge DB','TABLES','details printdb','[6]','_popup_'),(9,'file-export','exportCSV','CSV-Export','RESULTDETAILS','details import','[6]','_popup_');
...
set @pwd_login = '7uRM25xcYB1YZIlgBQ2';
...
flush logs;
-- Dump completed on 2020-04-06 15:37:56
