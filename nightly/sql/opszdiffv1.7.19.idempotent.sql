...
INSERT INTO `opsz_termine_permissions` (`keymachine`,`keyreadable`,`realid`,`typelist`,`edittype`,`referencetag`,`role_0`,`role_1`,`role_7`,`role_8`,`role_31`,`role_33`,`role_34`) SELECT 'emailonchange','Termin(-änderung) an KlientIn emailen','5.25','TEXT','FUNCTION; CHECKED','_emailonchange','0','0','0','0','0','0','0' FROM DUAL WHERE (SELECT count(*) FROM information_schema.COLUMNS WHERE TABLE_NAME = 'opsz_termine' AND COLUMN_NAME = 'emailonchange') > 0 AND (SELECT count(keymachine) FROM `opsz_termine_permissions` where keymachine = 'emailonchange') = 0;
